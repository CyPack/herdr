...
test:
    ...
    python3 -m unittest scripts.test_agent_detection_manifest_check scripts.test_behavior_registry_check scripts.test_changelog scripts.test_license_guard_check scripts.test_personal_identifier_check scripts.test_conventional_commits scripts.test_config_reference_check scripts.test_managed_overlay_check scripts.test_docs_translation_parity scripts.test_per_display_scheduling scripts.test_ui_hot_path_architecture scripts.test_hermes_integration_asset scripts.test_preview scripts.test_trail_t7_teardown scripts.test_vendor_libghostty_vt scripts.test_vendor_portable_pty scripts.test_python_suite_is_complete scripts.test_chat_context scripts.test_headful_bar scripts.test_headful_files_rail scripts.test_headful_files_beside scripts.test_headful_bar_focus scripts.test_headful_focus_toggle scripts.test_headful_bar_island scripts.test_headful_bar_toggle scripts.test_headful_bar_style scripts.test_package_windows_conpty scripts.test_unix_installer
