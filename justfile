...
test:
    ...
    python3 -m unittest scripts.test_agent_detection_manifest_check scripts.test_behavior_registry_check scripts.test_changelog scripts.test_license_guard_check scripts.test_config_reference_check scripts.test_managed_overlay_check scripts.test_docs_translation_parity scripts.test_per_display_scheduling scripts.test_hermes_integration_asset scripts.test_preview scripts.test_trail_t7_teardown scripts.test_vendor_libghostty_vt scripts.test_vendor_portable_pty
