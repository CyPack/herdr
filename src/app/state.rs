    ...
    pub fn items(&self) -> Vec<&str> {
        match &self.kind {
            ...
            ContextMenuKind::Pane {
                ...
                items.extend(["Split right", "Split down", "Open Files beside", "Zoom"]);
...
pub struct AppState {
    ...
    pub mouse_wheel_host_scroll: crate::config::MouseWheelHostScrollConfig,
    ...
    /// TP-INP-MOUSE-01
    pub(crate) pending_pane_pointer: Vec<crate::app::PanePointerPress>,
...
impl AppState {
    ...
    pub fn test_new() -> Self {
        Self {
            ...
            mouse_wheel_host_scroll: crate::config::MouseWheelHostScrollConfig::Mobile,
            confirm_close: true,
