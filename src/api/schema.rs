...
pub enum Method {
    ...
    #[serde(rename = "chat.seat")]
    ChatSeat(ChatSeatParams),
    #[serde(rename = "chat.unseat")]
    ChatUnseat(ChatUnseatParams),
    ...
    #[serde(rename = "pane.web.open")]
    PaneWebOpen(PaneWebOpenParams),
    ...
    #[serde(rename = "pane.sleep")]
    PaneSleep(PaneTarget),
    #[serde(rename = "closed_agent.revive")]
    ClosedAgentRevive(ClosedAgentReviveParams),
