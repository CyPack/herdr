...
| TP-TREE-11 | The active workspace row is filled with the accent and takes contrast text; a chat row never takes the accent background. | "Which workspace am I in" has two possible answers, or none — the tones were a step apart and the difference was not survivable at this width. | `the_active_workspace_row_wears_the_accent_and_a_chat_row_never_does` · `default_space_workspace_style_tracks_active_state` |
