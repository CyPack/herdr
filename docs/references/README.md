...
| **remote-media-transport** | `docs/references/remote-media-transport.md` | `docs/patterns/remote-media-transport.md` | **`RM1–RM13`** + anti-pattern **`RA1–RA10`** | *(registry içinde §7.5 ölçümler · §7.6 endüstri · §7.7 herdr-browser yüzeyi)* | *(F0'da üretilecek)* |
