...
<CardGrid>
  ...
  <Card title="Files">
    Open the built-in file manager, ride it beside a terminal, filter with `/`, and hand files to agents.

    [Browse with Files →](/docs/files/)
  </Card>
  <Card title="Click to open">
    Ctrl+click any path a terminal prints — with `:line` suffixes, quotes, and per-type destinations.

    [Learn the contract →](/docs/click-open/)
  </Card>
  <Card title="API">
